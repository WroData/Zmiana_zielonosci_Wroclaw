...
DIC_centers = list('Wroclaw' = c(51.10850, 17.0309636), 'Krakow' = c(50.0623969, 19.9386889), 'Warszawa' = c(52.2307014, 21.0095595), 'Nuremberg' = c(49.4496011, 11.078834))
...
for (path in list.dirs(paste0(DATA_PATH, CITY, '\\', "dane\\l2a\\"),recursive = FALSE) ){
  ...
  if(length(list.dirs(path, recursive = FALSE)) > 0){
    ...
    if (as.numeric(substr(d, start = 1, stop = 4 )) >= 2022) {
      offset = -1000
    } else {
      offset = 0
    }
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#### plot change ####
DIC_wolacz = list('Wroclaw' = 'we Wroclawiu', 'Krakow' = 'w Krakowie', 'Warszawa' = 'w Warszawie', 'Nuremberg' = 'Nuremberg')

plot_diff <- function(nvid_across_years, rok_poczatkowy, rok_koncowy, file_name_prefix = "", TITLE = "", SUBTITLE = ""){
...
# Lex szyszko
plot_diff(nvid_across_years, rok_poczatkowy = "r_2015_07_11", rok_koncowy = "r_2016_07_02")
plot_diff(nvid_across_years, rok_poczatkowy = "r_2016_07_02", rok_koncowy = "r_2017_07_30")

# poprawnosc ofsetu
plot_diff(nvid_across_years, rok_poczatkowy = "r_2021_06_19", rok_koncowy = "r_2022_06_19")

# kadencja Sutryka
plot_diff(nvid_across_years, rok_poczatkowy = "r_2018_07_07", rok_koncowy = "r_2023_09_07")
plot_diff(nvid_across_years, rok_poczatkowy = "r_2018_08_29", rok_koncowy = "r_2023_09_07")
plot_diff(nvid_across_years, rok_poczatkowy = "r_2018_07_07", rok_koncowy = "r_2023_05_27")
plot_diff(nvid_across_years, rok_poczatkowy = "r_2018_08_29", rok_koncowy = "r_2023_05_27")

# final
plot_diff(nvid_across_years, rok_poczatkowy = "r_2018_08_29", rok_koncowy = "r_2023_09_07", 
          file_name_prefix = 'FINAL_RAW_')

plot_diff(
  nvid_across_years, 
  rok_poczatkowy = "r_2018_08_29", 
  rok_koncowy = "r_2023_09_07", 
  file_name_prefix = 'FINAL_',
  TITLE = "W ciagu ostatnich 4 lat, powierzchnia zieleni we Wroclawiu wzrosla",
  SUBTITLE = "Ubytek zieleni widac w miejscach powstania nowych ciagów komunikacyjnych")
